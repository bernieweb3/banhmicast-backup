 ...
 * These types define the communication schema between CRE and ETH Sepolia contracts
 ...
 * @property {string} marketId - Market ID (uint256).
 ...
 * @property {string} user - ETH address of the bettor.
 * @property {Uint8Array} encryptedData - Encrypted payload data.
 * @property {string} commitmentHash - Hex-encoded keccak256 hash of the plaintext bet.
 */
...
/**
 * The result of batch execution, to be signed by the DON and submitted to Sepolia.
